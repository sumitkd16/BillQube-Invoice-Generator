...
const Template4 = ({ data }) => (
    <div className="border border-[#f97316] rounded-lg mx-auto my-4 px-4 py-3 w-full max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div>
                ...
                <h2 className="text-2xl font-bold text-black mb-1">{data.companyName}</h2>
                <p className="mb-1 text-black">{data.company}</p>
        ...
        <hr className="my-3 border-[#f97316]" />

        {/* Billing */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-4">
            {data.shippingName && (
                <div className="p-3 rounded bg-[#fef3c7] text-black">
                    <h3 className="text-lg font-semibold text-[#d97706] mb-2">Shipped To</h3>
            ...
            <div className="p-3 rounded bg-[#fef3c7] text-black">
                <h3 className="text-lg font-semibold text-[#d97706] mb-2">Billed To</h3>
        ...
        <div className="flex justify-end mb-4">
            <div className="p-3 bg-[#fef3c7] w-full max-w-xs text-neutral-800 space-y-1">
        ...
        {(data.accountName || data.accountNumber) && (
            <div className="mt-4 text-neutral-800 text-left">
                <h3 className="text-lg font-semibold text-[#d97706] mb-2">Bank Account Details</h3>
                {data.accountName && (
                ...
                {data.accountIFscCode && (
                    <p><strong>IFSC/Branch Code:</strong> {data.accountIFscCode}</p>
                )}
            </div>
        )}
        ...
        {data.notes && (
            <div className="mt-4 text-neutral-800 text-left">
                <h3 className="text-lg font-semibold text-[#d97706] mb-2">Remarks</h3>
                <p>{data.notes}</p>
            </div>
        )}
    </div>
