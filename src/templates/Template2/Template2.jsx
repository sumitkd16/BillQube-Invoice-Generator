// Template2.jsx  – Tailwind-only, blue theme
      ...
      <div className="max-w-[800px] w-full mx-auto my-4 px-4 py-3 border border-slate-300 rounded-lg bg-white text-slate-900">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start mb-4">
          ...
          <div className="space-y-1 mb-4 md:mb-0">
            ...
            <h2 className="text-lg font-bold text-blue-800">{data.companyName}</h2>
          ...
          <div className="text-left md:text-right space-y-0.5 text-sm">
            <h1 className="text-xl font-bold text-blue-600 mb-1">Invoice</h1>
        ...
        <hr className="my-3 border-blue-600" />

        {/* ── BILLING SECTION ─────────────────── */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
          {data.shippingName && data.shippingPhone && data.shippingAddress && (
              <div className="p-3 rounded bg-blue-50">
                <h3 className="text-base font-bold text-blue-600 mb-2">Shipped To</h3>
          ...
          <div className="p-3 rounded bg-blue-50">
            <h3 className="text-base font-bold text-blue-600 mb-2">Billed To</h3>
            <p className="font-medium">{data.billingName}</p>
        ...
        <div className="flex justify-end mb-4">
          <div className="p-3 max-w-[300px] w-full bg-blue-50 text-sm font-bold">
            ...
            <div className="flex justify-between text-blue-800 text-lg">
              <span>Total</span>
        ...
        {(data.accountName || data.accountNumber || data.accountIFscCode) && (
            <div className="mt-4">
              <h3 className="text-base font-bold text-blue-600 mb-2">Bank Account Details</h3>
        ...
        {data.notes && (
            <div className="mt-4">
              <h3 className="text-base font-bold text-blue-600 mb-2">Remarks</h3>
